 ...
 */
function process(pages, stylesheets, options, callback) {
    ...
    return lib.filterUnusedRules(pages, parsed.stylesheet, options.ignore, function (used_css) {
...
function uncss(files, opt, cb) {
    ...
    async.waterfall(
        [
            phantom.init.bind(null, numThreads),
