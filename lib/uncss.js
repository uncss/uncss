 ...
 * @param  {Array}    doms     List of DOMS loaded by PhantomJS
 * @param  {Object}   options  Options passed to the program
    ...
    phantom.init(function (err) {
        ...
        if (typeof files === 'string') {
            return phantom.fromRaw(files, options.timeout, function (err, res) {
                ...
                return uncss([''], [res], options, callback);
            });
        }
        /* Deprecated */
        ...
        return async.mapSeries(
            ...
            function (filename, onComplete) {
                ...
                return uncss(files, res, options, callback);
            }
        );
    });
}
