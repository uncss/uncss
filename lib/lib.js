 ...
 * @param  {Array} usedSelectors  List of Selectors found in {pages}
 * @return {Array}                The selectors matched in the DOMs
 */
function filterUnusedSelectors(pages, selectors, ignore, usedSelectors) {
